...
#class modal(discord.ui.Modal, title="Test modal"):
    user_name = discord.ui.TextInput(label="User's Discord Name", placeholder="eg. bob#0000 or @John", required=True, max_length=1000, style=discord.TextStyle.short)
    user_id = discord.ui.TextInput(label="what are you voting for", placeholder="Who should be mod", required=True, max_length=1000, style=discord.TextStyle.short)
    description = discord.ui.TextInput(label="Infomation", placeholder="eg. Bob should be mod, because he has treated us all respect and helps us with are needs", required=True, min_length=1 , max_length=2500, style=discord.TextStyle.paragraph)
...
#@client.tree.command(name="Test", description="Vote anonymous")
...
class TestMenuButton(discord.ui.View):
    ...
    async def test1(self, interaction: discord.Interaction, button: discord.Button):
        await interaction.channel.send(content="I have been pressed!1")
    @discord.ui.button(label="testB", style=discord.ButtonStyle.green)
    async def test2(self, interaction: discord.Interaction, button: discord.Button):
        await interaction.channel.send(content="I have been pressed!2")
    @discord.ui.button(label="testC", style=discord.ButtonStyle.red)
    async def test3(self, interaction: discord.Interaction, button: discord.Button):
        await interaction.channel.send(content="I have been pressed!3")
